...
export default function Home() {
  ...
  const topPlayers: PlayerRow[] = useMemo(() => {
    ...
    const out: PlayerRow[] = Array.from(byPlayer.entries()).map(([playerKey, s]) => ({
      player: playerKey,
      wins: s.wins,
      losses: s.losses,
      total: s.total,
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <div className="mx-auto max-w-4xl px-4 py-10">
        ...
        <div className="mt-6 rounded-2xl bg-white p-4 shadow-sm">
          ...
          <div className="mt-6">
            <div className="flex items-center justify-between">
              <div className="text-sm font-medium text-gray-700">Top Players by Win Rate <span className="text-gray-500">(min 15 games)</span></div>
              {topPlayers.length > 0 && (
            ...
            <div className="mt-3 overflow-x-auto">
              <table className="min-w-full text-left text-sm">
                ...
                <tbody>
                  {topPlayers.map((p, i) => (
                    <tr key={p.player + i} className="border-b">
